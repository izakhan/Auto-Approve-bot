...
async def approve(_, m : Message):
    ...
    try:
        ...
        await app.send_video(chat_id=kk.id, video=img, caption="**Hello {}!\nWelcome To {}\n\n__Powerd By : @Sarbudeen786**".format(m.from_user.mention, m.chat.title), reply_markup=button)
        add_user(kk.id)
        ...
        if m.chat.type == enums.ChatType.PRIVATE:
            ...
            keyboar = InlineKeyboardMarkup(
                [ 
                    ...
                    [
                        InlineKeyboardButton("💁‍♂️ Start me private 💁‍♂️", url="https://t.me/autoaccept_Requests_Bot?start")
                    ]
                ]
            )
            add_group(m.chat.id)
